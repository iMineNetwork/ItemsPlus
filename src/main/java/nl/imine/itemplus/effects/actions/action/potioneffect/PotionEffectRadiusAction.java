 ...
 * @author Dennis
 */
public class PotionEffectRadiusAction implements Action, ConfigurationSerializable {
    ...
    public PotionEffectRadiusAction(Player source, PotionEffect[] potionEffects, double radius, boolean playersOnly, boolean overwriteOldEffects) {
        this.potionEffects = potionEffects;
        this.targets = (List<LivingEntity>) source.getNearbyEntities(radius, radius, radius).stream().filter(entity -> entity instanceof LivingEntity);
        this.radius = radius;
